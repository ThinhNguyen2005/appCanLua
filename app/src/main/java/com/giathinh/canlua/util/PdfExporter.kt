...
object PdfExporter {
    ...
    fun export(context: Context, card: Card, entries: List<WeightEntry>): File {
        ...
        y = drawHeader(canvas, card, titlePaint, subtitlePaint, bodyPaint, borderPaint, shortHash, y, labels)
        y += 12f
    ...
    private fun drawHeader(
        ...
        canvas.drawText(labels.cardDate(card.id, shortDateFormat.format(card.date)), PAGE_WIDTH - MARGIN - 170f, y + 87f, bodyPaint)
